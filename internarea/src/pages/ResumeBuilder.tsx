...
export default function ResumeBuilder() {
    ...
    const fetchMyResumes = async () => {
        if (user?._id) {
            try {
                const res = await axios.get(`https://internarea-backend-kd6b.onrender.com/api/resume/my/${user._id}`);
    ...
    const createPayPalOrder = async (): Promise<string> => {
        try {
            const response = await axios.post("https://internarea-backend-kd6b.onrender.com/api/resume/create-order", {
    ...
    const capturePayPalOrder = async (orderID: string) => {
        try {
            ...
            const captureRes = await axios.post("https://internarea-backend-kd6b.onrender.com/api/resume/capture-order", {
                orderID,
                userId: user._id,
                details
            });
