...
export default function Requests() {
  ...
  useEffect(() => {
    if (user?._id) {
      axios.get(`https://internarea-backend-kd6b.onrender.com/api/friend-routes/requests/${user._id}`)
  ...
  const accept = async (id: string) => {
    try {
      await axios.post("https://internarea-backend-kd6b.onrender.com/api/friend-routes/accept", { requestId: id });
